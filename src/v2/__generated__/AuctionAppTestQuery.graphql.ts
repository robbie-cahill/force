...
export type AuctionAppTestQueryVariables = {
    input?: FilterArtworksInput | null | undefined;
    slug: string;
};
export type AuctionAppTestQueryResponse = {
    readonly me: {
...
export type AuctionAppTestQuery = {
    readonly response: AuctionAppTestQueryResponse;
    readonly variables: AuctionAppTestQueryVariables;
};



/*
query AuctionAppTestQuery(
...
fragment AuctionArtworkGrid_sale on Sale {
  internalID
  artworksConnection(first: 15, status: OPEN) {
    edges {
      node {
        id
        __typename
...
return {
      ...
      },
      {
        ...
        "selections": [
          ...
          (v37/*: any*/),
          {
            ...
            "storageKey": "artworksConnection(first:15,status:\"OPEN\")"
          },
          {
            "alias": null,
            "args": (v52/*: any*/),
  ...
  "params": {
    "cacheID": "de2c0ba0723e0e825936c7f1d04a4c84",
    "id": null,
    "metadata": {},
    "name": "AuctionAppTestQuery",
    "operationKind": "query",
